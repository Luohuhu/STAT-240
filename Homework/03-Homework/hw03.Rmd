...
ggplot(summary, aes(x=year,y=mean_radius,size=num)) +
  geom_point() +
  xlab("Year") +                
  ylab("Discovered Planets Number's Proportion") +                
  ggtitle("Annual Distribution of Discovered Planets Number") 
...
the dimensions of this data summary is 97 rows and 4 columns
...
The earliest: Radial Velocity
relative popularity: Transit
...
The minimum mass of planet discovered using Radial Velocity falls as the year grows.
...
ggplot(mean,aes(x = day))+
  ...
  xlab("Day") +
  ylab("Fahrenheit") +
  ggtitle("Distribution of Madison Mean Temperature",
          subtitle = " data from official Madison weather") +
